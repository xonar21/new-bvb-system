...
export interface WSMessage {
  type: 'load.created' | 'load.updated' | 'load.deleted' | 'load.order-updated' | 'presence' | 'cell.focus' | 'ip.restriction-changed' | 'layout.column-width-changed' | 'layout.row-height-changed' | 'layout.lock-acquired' | 'layout.lock-released' | 'layout.reset' | 'sync.started' | 'sync.progress' | 'loads.synced' | 'sync.error'
  payload: unknown
}
